...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-gradient">
      <a class="navbar-brand font-weight-bold" href="homePage.php">'.$systemName.'</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewVartList.php?catid=' .$row['categorieId']. '">' .$row['categorieName']. '</a>';
            }
            echo '</div>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="featuredArtist.php">Featured Artist</a>
          </li>
        ...
        <form method="get" action="/BETTR/search.php" class="form-inline my-2 my-lg-0 mx-3">
