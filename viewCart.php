                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    $mysql = "SELECT * FROM `vart` WHERE vartId = $vartId";
                                    $myresult = mysqli_query($conn, $mysql);
                                    $myrow = mysqli_fetch_assoc($myresult);
                                    $vartName = $myrow['vartName'];
                                    $vartPrice = $myrow['vartPrice'];
                                    $total = $vartPrice * $Quantity;
                                    $counter++;
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <form id="frm' . $vartId . '">
                                                    ...
                                                    <input type="number" name="quantity" value="' . $Quantity . '" class="text-center" onchange="updateCart(' . $vartId . ')" onkeyup="return false" style="width:60px" min=1 oninput="check(this)" onClick="this.select();">
                                                </form>
                                            </td>
                                            <td>' . $total . '</td>
                                            <td>
                                ...
                                if($counter==0) {
                                    ?><script> document.getElementById("cont").innerHTML = '<div class="col-md-12 my-5"><div class="card bg-dark"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3"><h3><strong class="text-light">Your Cart is Empty</strong></h3><h4 class="text-light">Lets Explore What You Want</h4> <a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true">Explore Here</a> </div></div></div></div>';</script> <?php
                                }
                            ?>
                        </tbody>
                    </table>
