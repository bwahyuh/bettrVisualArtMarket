...
<body style="background-color: black;">
    ...
    <div class="container my-3">
        <h2 class="py-2 text-white">Search Result for <em>"<?php echo $_GET['search']?>"</em> :</h2>
        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ?><script style> document.getElementById("cat").innerHTML = "Category: ";</script> <?php 
                $noResult = false;
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/card-'.$catId. '.jpg" class="card-img-top" alt="image for this vart" width="249px" height="270px">
                        <div class="card-body">
                            <h5 class="card-title"><a href="viewVartList.php?catid=' . $catId . '">' . $catname . '</a></h5>
                            <p class="card-text">' . substr($catdesc, 0, 29). '...</p>
                            <a href="viewVartList.php?catid=' . $catId . '" class="btn btn-primary">View All</a>
                        </div>
                    </div>
                </div>';
            }
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = "SELECT * FROM `vart` WHERE MATCH(vartName, vartDesc) against('$query')"; 
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3 mr-5 mb-2">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                ...
                                echo '</form>
                                <a href="viewVart.php?vartid=' . $vartId . '"><button class="btn btn-primary">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
