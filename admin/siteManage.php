...
echo '<div class="container-fluid" style="padding-left: 470px;margin-top:98px">
	<div class="card col-lg-6 p-0">
        <div class="title" style="background-color: black;">
            <em><h2 class="text-center text-light" style="margin-top: 11px;">' .$systemName. '</h2></em>
        </div>
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                ...
                <center>
                    <button name="updateDetail" class="btn btn-info btn-dark btn-block col-md-2">Save</button>
                </center>
            </form>
		</div>
	</div>';
