...
<body style="background-color: black;">
    ...
    <div class="container my-4 bg-secondary" id="cont">
        <div class="row jumbotron">
        <?php
            $vartId = $_GET['vartid'];
            $sql = "SELECT * FROM `vart` WHERE vartId = $vartId";
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php echo $vartName; ?>"; </script> 
        <?php
        echo  '<div class="col-md-4 ">
                <img src="img/vart-'.$vartId. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $vartName . '</h3>
                <h5 style="color: #ff0000">Rp. '.$vartPrice. '/-</h5>
                <p class="mb-0">' .$vartDesc .'</p>';
                ...
                <div class="mx-4">
                    <a href="viewVartList.php?catid=' . $vartCategorieId . '" class="active text-dark">
